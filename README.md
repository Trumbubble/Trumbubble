...
```yaml
name: Timothy Torubarov
studying_in: University of Oxford
area_of_study: Mathematics and Computer Science
...
<div style="background:#f6f8fa; border-radius:12px; padding:12px;">
  ...
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/scala/scala-original.svg" alt="scala" width="45" height="45"/>
...
```yaml
github: https://github.com/Trumbubble
email: ttorubarov@gmail.com
